...
from workers.briefing_worker import send_business_briefing, send_evening_briefing, send_morning_briefing, send_telegram_reminder
...
class WorkerSettings:
    functions = [extract_memories, send_morning_briefing, send_telegram_reminder, send_evening_briefing, send_business_briefing]
    cron_jobs = [
        cron(send_morning_briefing, hour=6, minute=15),   # 8:15am SAST (UTC+2)
        cron(send_business_briefing, hour=6, minute=20),  # 8:20am SAST (UTC+2)
