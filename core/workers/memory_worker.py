...
from workers.briefing_worker import (
    send_business_briefing,
    send_email_digest,
...
class WorkerSettings:
    functions = [
        extract_memories, send_morning_briefing, send_telegram_reminder,
        send_evening_briefing, send_business_briefing, send_email_digest,
    ]
    cron_jobs = [
        ...
        cron(send_email_digest, hour=10, minute=0),       # 12:00pm SAST (UTC+2)
